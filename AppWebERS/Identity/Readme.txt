...
<connectionStrings>
    <add name="DefaultConnection" providerName="MySql.Data.MySqlClient" connectionString="server=localhost;port=3306;database=prueba;uid=<user>;password=<password>; SslMode=None;" />
</connectionStrings>