...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser : IdentityUser
    {
         ...
         * Retorno: Operacion asincrona (Parecida a las promesas de js)
         */
        public Task<TUser> FindByRutAsync(string rut)
        {
            if (String.IsNullOrEmpty(rut))
            {
                throw new ArgumentNullException("rut");
            }

            TUser result = userTable.GetUserByRut(rut) as TUser;
            if (result != null)
            {
                return Task.FromResult<TUser>(result);
            }
         ...
         * Retorna: Operacion asincrona
         */
        public Task SetEstadoAsync(TUser user, bool estado)
        {
            user.Estado = estado;
         ...
         * Retorna: Operacion asincrona con el estado del usuario
         */
        public Task<bool> GetEstadoAsync(TUser user)
        {
            return Task.FromResult<bool>(user.Estado);
        }

        /* Creador: Gabriel Sanhueza
         * Accion: Obtiene el tipo de usuario
         * Retorna: Operacion asincrona con el tipo del usuario
         */
